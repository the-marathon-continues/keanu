...
if [[ -n "${KEANU_IOS_BUNDLE_SUFFIX:-}" ]]; then
  identity_source="${KEANU_IOS_BUNDLE_SUFFIX}"
else
...
bundle_base="${KEANU_IOS_APP_BUNDLE_ID:-${KEANU_IOS_BUNDLE_ID_BASE:-}}"
if [[ -z "${bundle_base}" ]]; then
  bundle_base="ai.openclaw.ios.test.${bundle_suffix}"
fi
bundle_base="$(normalize_bundle_id "${bundle_base}")"

share_bundle_id="${KEANU_IOS_SHARE_BUNDLE_ID:-${bundle_base}.share}"
watch_app_bundle_id="${KEANU_IOS_WATCH_APP_BUNDLE_ID:-${bundle_base}.watchkitapp}"
watch_extension_bundle_id="${KEANU_IOS_WATCH_EXTENSION_BUNDLE_ID:-${watch_app_bundle_id}.extension}"

code_sign_style="${KEANU_IOS_CODE_SIGN_STYLE:-Automatic}"
app_profile="${KEANU_IOS_APP_PROFILE:-}"
share_profile="${KEANU_IOS_SHARE_PROFILE:-}"
...
// KEANU_IOS_APP_BUNDLE_ID / KEANU_IOS_BUNDLE_ID_BASE
// KEANU_IOS_SHARE_BUNDLE_ID / KEANU_IOS_WATCH_APP_BUNDLE_ID / KEANU_IOS_WATCH_EXTENSION_BUNDLE_ID
// KEANU_IOS_CODE_SIGN_STYLE / KEANU_IOS_APP_PROFILE / KEANU_IOS_SHARE_PROFILE
KEANU_CODE_SIGN_STYLE = ${code_sign_style}
KEANU_DEVELOPMENT_TEAM = ${team_id}
// Keep legacy key for compatibility with older signing config paths.
KEANU_IOS_SELECTED_TEAM = ${team_id}
KEANU_APP_BUNDLE_ID = ${bundle_base}
KEANU_SHARE_BUNDLE_ID = ${share_bundle_id}
KEANU_WATCH_APP_BUNDLE_ID = ${watch_app_bundle_id}
KEANU_WATCH_EXTENSION_BUNDLE_ID = ${watch_extension_bundle_id}
KEANU_APP_PROFILE = ${app_profile}
KEANU_SHARE_PROFILE = ${share_profile}
EOF
