...
FEED_URL=${2:-"https://raw.githubusercontent.com/the-marathon-continues/keanu/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/the-marathon-continues/keanu/releases/download/v${VERSION}/"}
