...
# Output:
# - dist/Keanu.app
# - dist/Keanu-<version>.zip
# - dist/Keanu-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.keanu.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Keanu.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Keanu-$VERSION.zip"
DMG="$ROOT_DIR/dist/Keanu-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Keanu-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Keanu-$VERSION.dSYM.zip"
