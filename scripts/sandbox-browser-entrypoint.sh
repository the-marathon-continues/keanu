...
CDP_PORT="${KEANU_BROWSER_CDP_PORT:-${KEANU_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${KEANU_BROWSER_CDP_SOURCE_RANGE:-${KEANU_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${KEANU_BROWSER_VNC_PORT:-${KEANU_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${KEANU_BROWSER_NOVNC_PORT:-${KEANU_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${KEANU_BROWSER_ENABLE_NOVNC:-${KEANU_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${KEANU_BROWSER_HEADLESS:-${KEANU_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${KEANU_BROWSER_NO_SANDBOX:-${KEANU_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${KEANU_BROWSER_NOVNC_PASSWORD:-${KEANU_BROWSER_NOVNC_PASSWORD:-}}"
