...
describe("stochastic", () => {
  ...
  describe("shouldExplore", () => {
    ...
    it("increases exploration for complex tasks", () => {
      ...
      for (let i = 0; i < 50; i++) {
        if (shouldExplore(initStochasticState(i), 1, null, "high")) exploredComplex++;
        if (shouldExplore(initStochasticState(i), 1, null, "low")) exploredSimple++;
      }
