import type { KeanuConfig, PluginRuntime, ResolvedLineAccount } from "keanu/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: KeanuConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: KeanuConfig; accountId: string }): Promise<{
