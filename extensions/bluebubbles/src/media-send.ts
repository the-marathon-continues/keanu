...
import { resolveChannelMediaMaxBytes, type KeanuConfig } from "keanu/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: KeanuConfig; accountId?: string }): string[] {
