...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "keanu/plugin-sdk";
...
import { resolvePreferredKeanuTmpDir } from "../../../src/infra/tmp-keanu-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredKeanuTmpDir(), "msteams-mention-"));
