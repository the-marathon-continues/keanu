import type { ChannelOnboardingAdapter, KeanuConfig, WizardPrompter } from "keanu/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.keanu.ai/channels/mattermost",
    ].join("\n"),
