...
Keanu treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.keanu/settings/voicewake.json`

Shape:

```json
{ "triggers": ["keanu", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
