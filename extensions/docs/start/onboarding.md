---
summary: "First-run onboarding flow for Keanu (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Keanu">
...
<Step title="CLI">
  ...
  The app can install the global `keanu` CLI via npm/pnpm so terminal
