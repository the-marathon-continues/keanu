---
summary: "Overview of Keanu onboarding options and flows"
read_when:
...
Keanu supports multiple onboarding paths depending on where the Gateway runs
...
- [`keanu onboard` command](/cli/onboard)

## macOS app onboarding

Use the Keanu app when you want a fully guided setup on macOS. Docs:
