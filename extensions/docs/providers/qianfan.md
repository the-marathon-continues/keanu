---
summary: "Use Qianfan's unified API to access many models in Keanu"
read_when:
...
3. Keanu installed on your system
...
4. Copy the API key for use with Keanu

## CLI setup

```bash
keanu onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Keanu Configuration](/gateway/configuration)
