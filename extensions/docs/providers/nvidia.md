---
summary: "Use NVIDIA's OpenAI-compatible API in Keanu"
read_when:
  - You want to use NVIDIA models in Keanu
...
keanu onboard --auth-choice skip
keanu models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
