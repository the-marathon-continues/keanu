---
summary: "Use Synthetic's Anthropic-compatible API in Keanu"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Keanu registers it as the
...
Note: Keanu's Anthropic client appends `/v1` to the base URL, so use
