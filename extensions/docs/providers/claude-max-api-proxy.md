...
You can point Keanu at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Keanu
...
- [Anthropic provider](/providers/anthropic) - Native Keanu integration with Claude setup-token or API keys
