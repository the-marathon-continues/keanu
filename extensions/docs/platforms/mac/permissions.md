...
- Same path: run the app from a fixed location (for Keanu, `dist/Keanu.app`).
...
Workaround: move files into the Keanu workspace (`~/.keanu/workspace`) if you want to avoid per-folder grants.
