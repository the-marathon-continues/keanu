...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Keanu HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `keanu pairing approve slack <code>`.
...
Keanu supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Keanu falls back to normal delivery for remaining payloads.
