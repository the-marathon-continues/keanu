---
summary: "Synology Chat webhook setup and Keanu config"
read_when:
  - Setting up Synology Chat with Keanu
...
```bash
keanu plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Keanu gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Keanu.
...
- Pairing approvals work with:
  - `keanu pairing list synology-chat`
  - `keanu pairing approve synology-chat <CODE>`
...
```bash
keanu message send --channel synology-chat --target 123456 --text "Hello from Keanu"
keanu message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
