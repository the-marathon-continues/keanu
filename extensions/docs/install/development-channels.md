...
Keanu ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Keanu also aligns
the install method:
...
When you switch channels with `keanu update`, Keanu also syncs plugin sources:
