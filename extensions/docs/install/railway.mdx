...
Deploy Keanu on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/keanu` — Control UI
...
- `KEANU_STATE_DIR=/data/.keanu` (recommended)
- `KEANU_WORKSPACE_DIR=/data/workspace` (recommended)
- `KEANU_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Keanu state + workspace so you can migrate to another host without losing config or memory.
