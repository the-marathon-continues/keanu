...
import type { ReplyPayload, KeanuConfig } from "keanu/plugin-sdk";
import { createReplyPrefixOptions } from "keanu/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as KeanuConfig;
