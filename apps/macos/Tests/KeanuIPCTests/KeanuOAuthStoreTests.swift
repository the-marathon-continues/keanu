...
struct KeanuOAuthStoreTests {
    ...
    func returnsMissingWhenFileAbsent() {
        ...
        #expect(KeanuOAuthStore.anthropicOAuthStatus(at: url) == .missingFile)
    }

    @Test
    func usesEnvOverrideForKeanuOAuthDir() throws {
        ...
        #expect(KeanuOAuthStore.oauthDir().standardizedFileURL == dir.standardizedFileURL)
    }
    ...
    func acceptsPiFormatTokens() throws {
        ...
        #expect(KeanuOAuthStore.anthropicOAuthStatus(at: url).isConnected)
    }
    ...
    func reportsMissingProviderEntry() throws {
        ...
        #expect(KeanuOAuthStore.anthropicOAuthStatus(at: url) == .missingProviderEntry)
    }
    ...
    func reportsMissingTokens() throws {
        ...
        #expect(KeanuOAuthStore.anthropicOAuthStatus(at: url) == .missingTokens)
    }
