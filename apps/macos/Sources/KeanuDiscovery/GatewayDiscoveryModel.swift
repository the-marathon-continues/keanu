...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "ai.keanu", category: "gateway-discovery")
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = KeanuBonjour.wideAreaGatewayServiceDomain,
    ...
    private var hasUsableWideAreaResults: Bool {
        guard let domain = KeanuBonjour.wideAreaGatewayServiceDomain else { return false }
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (Keanu)", with: "")
