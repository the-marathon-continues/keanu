...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Keanu token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: KeanuOAuthStore.AnthropicOAuthStatus = KeanuOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.keanu", category: "anthropic-oauth")
...
enum KeanuOAuthStore {
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Keanu OAuth token file not found"
            case .unreadableFile: "Keanu OAuth token file not readable"
            case .invalidJSON: "Keanu OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Keanu OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Keanu OAuth credentials found"
            }
        }
    }
