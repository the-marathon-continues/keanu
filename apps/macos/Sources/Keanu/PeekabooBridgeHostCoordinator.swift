...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.keanu", category: "PeekabooBridge")
    ...
    private static var openclawSocketPath: String {
        ...
        let directory = base.appendingPathComponent("Keanu", isDirectory: true)
    ...
    private func startIfNeeded() async {
        ...
        let services = KeanuPeekabooBridgeServices()
...
@MainActor
private final class KeanuPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "ai.keanu.peekaboo")
