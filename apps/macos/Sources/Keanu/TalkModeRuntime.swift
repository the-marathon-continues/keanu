...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.keanu", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.keanu", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [KeanuChatMessage] = messages.compactMap { item in
