...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/the-marathon-continues/keanu") {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://keanu.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "KeanuBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KeanuBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "KeanuGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KeanuGitCommit") as? String) ??
            "unknown"
    }
