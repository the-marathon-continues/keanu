...
enum UIStrings {
    static let welcomeTitle = "Welcome to Keanu"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: KeanuOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: KeanuChatViewModel
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: KeanuChatViewModel(
