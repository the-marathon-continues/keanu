...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.keanu", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Keanu windows, but below the system’s pop-up menus.
