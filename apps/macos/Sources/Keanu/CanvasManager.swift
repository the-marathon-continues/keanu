...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.keanu", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Keanu/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__keanu__/a2ui/").absoluteString + "?platform=macos"
    }
