...
import ai.keanu.android.ui.mobileSurface
import ai.keanu.android.ui.mobileText
import ai.keanu.android.ui.mobileTextSecondary
import ai.keanu.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.keanu.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.keanu.android.ui.mobileFontFamily,
