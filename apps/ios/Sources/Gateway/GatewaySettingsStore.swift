...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.keanu.gateway"
    private static let nodeService = "ai.keanu.node"
    private static let talkService = "ai.keanu.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.keanu.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.keanu.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("keanu-gateway.log")
    }
