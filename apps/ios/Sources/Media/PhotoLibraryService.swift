...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: KeanuPhotosLatestParams) async throws -> KeanuPhotosLatestPayload {
        ...
        return KeanuPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> KeanuPhotoPayload
    {
