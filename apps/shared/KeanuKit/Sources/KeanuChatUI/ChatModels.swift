...
public typealias KeanuPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias KeanuPlatformImage = UIImage
#endif

public struct KeanuChatUsageCost: Codable, Hashable, Sendable {
...
public struct KeanuChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: KeanuChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(KeanuChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct KeanuChatMessageContent: Codable, Hashable, Sendable {
...
public struct KeanuChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [KeanuChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: KeanuChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [KeanuChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: KeanuChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(KeanuChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([KeanuChatMessageContent].self, forKey: .content) {
...
public struct KeanuChatHistoryPayload: Codable, Sendable {
...
public struct KeanuSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct KeanuSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [KeanuSessionPreviewItem]
}

public struct KeanuSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [KeanuSessionPreviewEntry]

    public init(ts: Int, previews: [KeanuSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct KeanuChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct KeanuChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct KeanuAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct KeanuChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct KeanuGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct KeanuPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: KeanuPlatformImage?
...
public struct KeanuChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
