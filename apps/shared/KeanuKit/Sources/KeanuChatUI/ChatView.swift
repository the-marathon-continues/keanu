...
@MainActor
public struct KeanuChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: KeanuChatViewModel
    ...
    private var visibleMessages: [KeanuChatMessage] {
        let base: [KeanuChatMessage]
    ...
    private func mergeToolResults(in messages: [KeanuChatMessage]) -> [KeanuChatMessage] {
    ...
    private func isToolResultMessage(_ message: KeanuChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: KeanuChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: KeanuChatMessage) -> String {
