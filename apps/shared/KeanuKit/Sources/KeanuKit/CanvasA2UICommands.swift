...
public enum KeanuCanvasA2UICommand: String, Codable, Sendable {
...
public struct KeanuCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct KeanuCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
