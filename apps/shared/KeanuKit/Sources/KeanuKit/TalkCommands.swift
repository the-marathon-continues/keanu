...
public enum KeanuTalkCommand: String, Codable, Sendable {
...
public struct KeanuTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct KeanuTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
