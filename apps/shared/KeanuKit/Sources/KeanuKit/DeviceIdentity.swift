...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["KEANU_STATE_DIR", "OPENCLAW_STATE_DIR"]
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("Keanu", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("keanu", isDirectory: true)
    }
}
