...
public enum KeanuBonjour {
    public static let gatewayServiceType = "_keanu-gw._tcp"
    public static let legacyGatewayServiceType = "_openclaw-gw._tcp"
    public static let gatewayServiceDomain = "local."
    public static var wideAreaGatewayServiceDomain: String? {
        let env = ProcessInfo.processInfo.environment
        return resolveWideAreaDomain(env["KEANU_WIDE_AREA_DOMAIN"] ?? env["OPENCLAW_WIDE_AREA_DOMAIN"])
    }
