...
import "@a2ui/lit/ui";
import { themeContext } from "@keanu/a2ui-theme-context";
...
class KeanuA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  #handleA2UIAction(evt) {
    ...
    const handler =
      globalThis.webkit?.messageHandlers?.keanuCanvasA2UIAction ??
      globalThis.keanuCanvasA2UIAction;
