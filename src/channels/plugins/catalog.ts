...
import { discoverKeanuPlugins } from "../../plugins/discovery.js";
import type { KeanuPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, KeanuPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["KEANU_PLUGIN_CATALOG_PATHS", "KEANU_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<KeanuPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: KeanuPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverKeanuPlugins({ workspaceDir: options.workspaceDir });
