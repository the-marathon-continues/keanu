...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: KeanuConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: KeanuConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: KeanuConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: KeanuConfig; accountId?: string | null }) => number | undefined;
