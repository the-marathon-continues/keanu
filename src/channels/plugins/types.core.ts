...
export type ChannelAgentToolFactory = (params: { cfg?: KeanuConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: KeanuConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: KeanuConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: KeanuConfig }) => boolean;
  supportsCards?: (params: { cfg: KeanuConfig }) => boolean;
