...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.KEANU_TTS_PREFS;
      process.env.KEANU_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.KEANU_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: KeanuConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
