...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: KeanuConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: KeanuConfig): Promise<MessageChannelId[]> {
