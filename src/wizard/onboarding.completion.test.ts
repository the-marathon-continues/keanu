...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("keanu");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "keanu");
