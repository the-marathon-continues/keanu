...
export const A2UI_PATH = "/__keanu__/a2ui";

export const CANVAS_HOST_PATH = "/__keanu__/canvas";

export const CANVAS_WS_PATH = "/__keanu__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.keanuCanvasA2UIAction.postMessage(...)
  // - Android: window.keanuCanvasA2UIAction.postMessage(...)
  const handlerNames = ["keanuCanvasA2UIAction"];
  ...
  globalThis.Keanu = globalThis.Keanu ?? {};
  globalThis.Keanu.postMessage = postToNode;
  globalThis.Keanu.sendUserAction = sendUserAction;
  globalThis.keanuPostMessage = postToNode;
  globalThis.keanuSendUserAction = sendUserAction;
