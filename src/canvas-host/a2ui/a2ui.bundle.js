...
const t$6 = globalThis,
  e$13 =
    t$6.ShadowRoot &&
    (void 0 === t$6.ShadyCSS || t$6.ShadyCSS.nativeShadow) &&
...
var n$12 = class {
  ...
  get styleSheet() {
    ...
    if (e$13 && void 0 === t) {
      ...
      (e && (t = o$14.get(s)),
        void 0 === t &&
          ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), e && o$14.set(s, t)));
    }
    return t;
  }
  toString() {
 ...
 */ const {
    is: i$8,
    defineProperty: e$12,
    getOwnPropertyDescriptor: h$6,
    getOwnPropertyNames: r$10,
    getOwnPropertySymbols: o$13,
    getPrototypeOf: n$11,
  } = Object,
  a$1 = globalThis,
  c$5 = a$1.trustedTypes,
  l$4 = c$5 ? c$5.emptyScript : "",
...
const t$5 = globalThis,
  i$7 = (t) => t,
  s$7 = t$5.trustedTypes,
  e$11 = s$7 ? s$7.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  h$5 = "$lit$",
  o$12 = `lit$${Math.random().toFixed(9).slice(2)}$`,
  n$10 = "?" + o$12,
  r$9 = `<${n$10}>`,
  l$3 = document,
  ...
  for (let i = 0; i < s; i++) {
    ...
    l +=
      c === v$1
        ? s + r$9
        : d >= 0
          ? (e.push(a), s.slice(0, d) + h$5 + s.slice(d) + o$12 + x)
          : s + o$12 + (-2 === d ? i : x);
  }
          ...
          for (const t of r.getAttributeNames())
            if (t.endsWith(h$5)) {
              ...
              t.startsWith(o$12) &&
                ...
                r.removeAttribute(t));
        if (y.test(r.tagName)) {
          const t = r.textContent.split(o$12),
            i = t.length - 1;
          if (i > 0) {
...
var R = class {
  ...
  u(t) {
    const {
      ...
      e = (t?.creationScope ?? l$3).importNode(i, !0);
    P.currentNode = e;
    let h = P.nextNode(),
      o = 0,
      n = 0,
...
var k = class k {
  ...
  k(t) {
    ...
    for (const h of t)
      (e === i.length
        ? i.push((s = new k(this.O(c$4()), this.O(c$4()), this, this.options)))
        : (s = i[e]),
        s._$AI(h),
        e++);
    ...
    class extends i$5 {
      ...
      update(s, [t, r, c]) {
        ...
        for (; x <= j && k <= w; )
          ...
          else if ((void 0 === m && ((m = u(a, k, w)), (y = u(h, x, j))), m.has(h[x])))
            if (m.has(h[j])) {
              const e = y.get(a[k]),
                t = void 0 !== e ? d[e] : null;
              if (null === t) {
 ...
 */ var s$3 = class {
  constructor(t, s, i, h) {
    if (
      ...
      (this.t = (t, s) => {
        (this.unsubscribe &&
          (this.unsubscribe !== s && ((this.provided = !1), this.unsubscribe()),
...
function isResolvedButton(props) {
  return (
    isObject$1(props) && "child" in props && isAnyComponentNode(props.child) && "action" in props
  );
}
  ...
  return (e, o) =>
    "object" == typeof o
      ...
      : ((t, e, o) => {
          ...
          return (
            e.constructor.createProperty(o, t), r ? Object.getOwnPropertyDescriptor(e, o) : void 0
          );
        })(t, e, o);
}
    ...
    : class extends i {
        ...
        _$Sl() {
          ...
          const e =
            null === (t = this.h) || void 0 === t
              ? void 0
              : t.getPending().filter((t) => t !== this._$Su && !this._$St.has(t));
          (s.forEach((t) => t.get()),
            null === (i = this._$Su) || void 0 === i || i.get(),
            e.forEach((t) => t.get()),
            h.forEach((t) => t.get()));
        }
        _$Sv() {
        ...
        _$S_() {
          ...
          const i = (this.h = new Signal.subtle.Watcher(function () {
            ...
            void 0 !== t &&
              (!1 === t._$Si &&
                (new Set(this.getPending()).has(t._$Su) ? t.requestUpdate() : t._$Sv()),
              this.watch());
          }));
          (n$4.set(i, this),
            e$3.register(this, i),
            i.watch(this._$Su),
            i.watch(...Array.from(this._$St).map(([t]) => t)));
        }
        _$Sp() {
          if (void 0 === this.h) return;
          let i = !1;
          (this.h.unwatch(
            ...Signal.subtle.introspectSources(this.h).filter((t) => {
              var s;
              const h =
                !0 !== (null === (s = this._$St.get(t)) || void 0 === s ? void 0 : s.manualDispose);
        ...
        updateEffect(i, s) {
          ...
          return (
            this.h.watch(e),
            this._$St.set(e, s),
            null !== (h = null == s ? void 0 : s.beforeUpdate) && void 0 !== h && h
              ? Signal.subtle.untrack(() => e.get())
              : this.updateComplete.then(() => Signal.subtle.untrack(() => e.get())),
            () => {
...
function n$3(i, t = !1, e = 0) {
  ...
  if (void 0 !== h && 0 !== h.size)
    if (t)
      if (Array.isArray(r)) for (let i = e; i < r.length; i++) (s(r[i], !1), o$6(r[i]));
...
var r$2 = class extends f {
  _$S_() {
    var i, t;
    void 0 === this._$Sm &&
      ((this._$Sj = new Signal.Computed(() => {
        var i;
        const t = null === (i = this._$SW) || void 0 === i ? void 0 : i.get();
        return (this.setValue(t), t);
      })),
      (this._$Sm =
        null !== (t = null === (i = this._$Sk) || void 0 === i ? void 0 : i.h) && void 0 !== t
          ? t
          : n$2),
      this._$Sm.watch(this._$Sj),
  ...
  update(i, [t]) {
    var o, n;
    return (
      (null !== (o = this._$Sk) && void 0 !== o) ||
        (this._$Sk = null === (n = i.options) || void 0 === n ? void 0 : n.host),
      t !== this._$SW && void 0 !== this._$SW && this._$Sp(),
      (this._$SW = t),
      this._$S_(),
      Signal.subtle.untrack(() => this._$SW.get())
    );
  }
  disconnected() {
    this._$Sp();
  ...
  var Root = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$19(
        ...
        _component_initializers,
        _component_extraInitializers,
      );
      __esDecorate$19(
        this,
        null,
      ...
      __esDecorate$19(
        ...
        _childComponents_initializers,
        _childComponents_extraInitializers,
      );
      __esDecorate$19(
        this,
        null,
        _processor_decorators,
        {
          kind: "accessor",
          name: "processor",
          static: false,
        ...
        _processor_initializers,
        _processor_extraInitializers,
      );
      __esDecorate$19(
        this,
        null,
        ...
        _dataContextPath_initializers,
        _dataContextPath_extraInitializers,
      );
      __esDecorate$19(
        this,
        null,
        _enableCustomElements_decorators,
        {
          kind: "accessor",
        ...
        _enableCustomElements_initializers,
        _enableCustomElements_extraInitializers,
      );
      __esDecorate$19(
        this,
        null,
        _set_weight_decorators,
        {
          kind: "setter",
          name: "weight",
          static: false,
    ...
    #surfaceId_accessor_storage =
      (__runInitializers$19(this, _instanceExtraInitializers),
      __runInitializers$19(this, _surfaceId_initializers, null));
    get surfaceId() {
    ...
    #component_accessor_storage =
      (__runInitializers$19(this, _surfaceId_extraInitializers),
      __runInitializers$19(this, _component_initializers, null));
    get component() {
    ...
    #theme_accessor_storage =
      (__runInitializers$19(this, _component_extraInitializers),
      __runInitializers$19(this, _theme_initializers, void 0));
    get theme() {
    ...
    #childComponents_accessor_storage =
      (__runInitializers$19(this, _theme_extraInitializers),
      __runInitializers$19(this, _childComponents_initializers, null));
    get childComponents() {
    ...
    #processor_accessor_storage =
      (__runInitializers$19(this, _childComponents_extraInitializers),
      __runInitializers$19(this, _processor_initializers, null));
    get processor() {
    ...
    #dataContextPath_accessor_storage =
      (__runInitializers$19(this, _processor_extraInitializers),
      __runInitializers$19(this, _dataContextPath_initializers, ""));
    get dataContextPath() {
    ...
    #enableCustomElements_accessor_storage =
      (__runInitializers$19(this, _dataContextPath_extraInitializers),
      __runInitializers$19(this, _enableCustomElements_initializers, false));
 ...
 */ const e$2 = e$10(
  class extends i$5 {
    constructor(t) {
      if ((super(t), t.type !== t$4.ATTRIBUTE || "class" !== t.name || t.strings?.length > 2))
        throw Error(
 ...
 */ const n$1 = "important",
  ...
  o$2 = e$10(
    class extends i$5 {
      constructor(t) {
        if ((super(t), t.type !== t$4.ATTRIBUTE || "style" !== t.name || t.strings?.length > 2))
          throw Error(
  ...
  var Button = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$17(
        ...
        _action_initializers,
        _action_extraInitializers,
      );
      __esDecorate$17(
        null,
        (_classDescriptor = { value: _classThis }),
...
let Checkbox = (() => {
  ...
  var Checkbox = class extends _classSuper {
    ...
    #label_accessor_storage =
      (__runInitializers$15(this, _value_extraInitializers),
      __runInitializers$15(this, _label_initializers, null));
    get label() {
...
let Column = (() => {
  ...
  var Column = class extends _classSuper {
    ...
    static {
      const _metadata =
        typeof Symbol === "function" && Symbol.metadata
          ? Object.create(_classSuper[Symbol.metadata] ?? null)
          : void 0;
      _alignment_decorators = [
        n$6({
          reflect: true,
          type: String,
        }),
      ];
      _distribution_decorators = [
        n$6({
          reflect: true,
          type: String,
        }),
      ...
      __esDecorate$14(
        ...
        _alignment_initializers,
        _alignment_extraInitializers,
      );
      __esDecorate$14(
        this,
        null,
        ...
        _distribution_initializers,
        _distribution_extraInitializers,
      );
      __esDecorate$14(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #distribution_accessor_storage =
      (__runInitializers$14(this, _alignment_extraInitializers),
      __runInitializers$14(this, _distribution_initializers, "start"));
    get distribution() {
...
let DateTimeInput = (() => {
  ...
  var DateTimeInput = class extends _classSuper {
    ...
    static {
      ...
      _value_decorators = [n$6()];
      _label_decorators = [n$6()];
      _enableDate_decorators = [
        n$6({
          reflect: false,
          type: Boolean,
        }),
      ];
      _enableTime_decorators = [
        n$6({
          reflect: false,
          type: Boolean,
        }),
      ...
      __esDecorate$13(
        ...
        _enableDate_initializers,
        _enableDate_extraInitializers,
      );
      __esDecorate$13(
        this,
        null,
        ...
        _enableTime_initializers,
        _enableTime_extraInitializers,
      );
      __esDecorate$13(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #label_accessor_storage =
      (__runInitializers$13(this, _value_extraInitializers),
      __runInitializers$13(this, _label_initializers, null));
    get label() {
      return this.#label_accessor_storage;
    }
    set label(value) {
    ...
    #enableDate_accessor_storage =
      (__runInitializers$13(this, _label_extraInitializers),
      __runInitializers$13(this, _enableDate_initializers, true));
    get enableDate() {
    ...
    #enableTime_accessor_storage =
      (__runInitializers$13(this, _enableDate_extraInitializers),
      __runInitializers$13(this, _enableTime_initializers, true));
    get enableTime() {
...
let Image = (() => {
  ...
  var Image = class extends _classSuper {
    ...
    #usageHint_accessor_storage =
      (__runInitializers$10(this, _url_extraInitializers),
      __runInitializers$10(this, _usageHint_initializers, null));
    get usageHint() {
    ...
    #fit_accessor_storage =
      (__runInitializers$10(this, _usageHint_extraInitializers),
      __runInitializers$10(this, _fit_initializers, null));
    get fit() {
  ...
  var List = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$9(
        ...
        _direction_initializers,
        _direction_extraInitializers,
      );
      __esDecorate$9(
        null,
        (_classDescriptor = { value: _classThis }),
  ...
  var MultipleChoice = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$8(
        ...
        _options_initializers,
        _options_extraInitializers,
      );
      __esDecorate$8(
        this,
        null,
        _selections_decorators,
        {
          kind: "accessor",
          name: "selections",
          static: false,
        ...
        _selections_initializers,
        _selections_extraInitializers,
      );
      __esDecorate$8(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #options_accessor_storage =
      (__runInitializers$8(this, _description_extraInitializers),
      __runInitializers$8(this, _options_initializers, []));
    get options() {
    ...
    #selections_accessor_storage =
      (__runInitializers$8(this, _options_extraInitializers),
      __runInitializers$8(this, _selections_initializers, []));
    get selections() {
    ...
    class extends f {
      ...
      get lt() {
        return "function" == typeof this.G
          ? o$1.get(this.ht ?? globalThis)?.get(this.G)
          : this.G?.value;
      }
      disconnected() {
...
let Modal = (() => {
  ...
  var Modal = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$7(
        this,
        (_private_showModal_descriptor = {
          get: __setFunctionName(
            function () {
        ...
        _private_showModal_initializers,
        _private_showModal_extraInitializers,
      );
      __esDecorate$7(
        this,
        (_private_modalRef_descriptor = {
          get: __setFunctionName(
            function () {
        ...
        _private_modalRef_initializers,
        _private_modalRef_extraInitializers,
      );
      __esDecorate$7(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #modalRef_accessor_storage =
      (__runInitializers$7(this, _private_showModal_extraInitializers),
      __runInitializers$7(this, _private_modalRef_initializers, null));
    get #modalRef() {
...
let Row = (() => {
  ...
  var Row = class extends _classSuper {
    ...
    #distribution_accessor_storage =
      (__runInitializers$6(this, _alignment_extraInitializers),
      __runInitializers$6(this, _distribution_initializers, "start"));
    get distribution() {
      return this.#distribution_accessor_storage;
    }
    set distribution(value) {
  ...
  var Slider = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$5(
        ...
        _minValue_initializers,
        _minValue_extraInitializers,
      );
      __esDecorate$5(
        this,
        null,
        _maxValue_decorators,
        {
          kind: "accessor",
          name: "maxValue",
          static: false,
        ...
        _maxValue_initializers,
        _maxValue_extraInitializers,
      );
      __esDecorate$5(
        this,
        null,
      ...
      __esDecorate$5(
        ...
        _inputType_initializers,
        _inputType_extraInitializers,
      );
      __esDecorate$5(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #minValue_accessor_storage =
      (__runInitializers$5(this, _value_extraInitializers),
      __runInitializers$5(this, _minValue_initializers, 0));
    get minValue() {
    ...
    #maxValue_accessor_storage =
      (__runInitializers$5(this, _minValue_extraInitializers),
      __runInitializers$5(this, _maxValue_initializers, 0));
    get maxValue() {
    ...
    #label_accessor_storage =
      (__runInitializers$5(this, _maxValue_extraInitializers),
      __runInitializers$5(this, _label_initializers, null));
    get label() {
      return this.#label_accessor_storage;
    }
    set label(value) {
    ...
    #inputType_accessor_storage =
      (__runInitializers$5(this, _label_extraInitializers),
      __runInitializers$5(this, _inputType_initializers, null));
    get inputType() {
  ...
  var Surface = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$4(
        ...
        _surface_initializers,
        _surface_extraInitializers,
      );
      __esDecorate$4(
        this,
        null,
    ...
    #surface_accessor_storage =
      (__runInitializers$4(this, _surfaceId_extraInitializers),
      __runInitializers$4(this, _surface_initializers, null));
    get surface() {
    ...
    #processor_accessor_storage =
      (__runInitializers$4(this, _surface_extraInitializers),
      __runInitializers$4(this, _processor_initializers, null));
    get processor() {
      return this.#processor_accessor_storage;
    }
    set processor(value) {
  ...
  var Tabs = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate$3(
        ...
        _titles_initializers,
        _titles_extraInitializers,
      );
      __esDecorate$3(
        this,
        null,
        _selected_decorators,
        {
          kind: "accessor",
          name: "selected",
          static: false,
        ...
        _selected_initializers,
        _selected_extraInitializers,
      );
      __esDecorate$3(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #selected_accessor_storage =
      (__runInitializers$3(this, _titles_extraInitializers),
      __runInitializers$3(this, _selected_initializers, 0));
    get selected() {
...
let TextField = (() => {
  ...
  var TextField = class extends _classSuper {
    ...
    #label_accessor_storage =
      (__runInitializers$2(this, _text_extraInitializers),
      __runInitializers$2(this, _label_initializers, null));
    get label() {
      return this.#label_accessor_storage;
    }
    set label(value) {
    ...
    #inputType_accessor_storage =
      (__runInitializers$2(this, _label_extraInitializers),
      __runInitializers$2(this, _inputType_initializers, null));
    get inputType() {
      return this.#inputType_accessor_storage;
    }
    set inputType(value) {
 ...
 */ var e = class extends i$5 {
  constructor(i) {
    if ((super(i), (this.it = A), i.type !== t$4.CHILD))
  ...
  for (let closerIdx = 0; closerIdx < max; closerIdx++) {
    ...
    for (; openerIdx > minOpenerIdx; openerIdx -= jumps[openerIdx] + 1) {
      ...
      if (opener.open && opener.end < 0) {
        ...
        if (!isOddMatch) {
          const lastJump =
            openerIdx > 0 && !delimiters[openerIdx - 1].open ? jumps[openerIdx - 1] + 1 : 0;
...
var KeanuA2UIHost = class extends i$6 {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = i$9`
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--keanu-a2ui-inset-top, 0px)
        var(--keanu-a2ui-inset-right, 0px)
        var(--keanu-a2ui-inset-bottom, 0px)
        var(--keanu-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--keanu-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--keanu-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--keanu-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--keanu-a2ui-empty-top, var(--keanu-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.keanuA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["keanu:a2ui-action-status"]) {
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis.__keanuLastA2UIAction = userAction;
    const handler =
      globalThis.webkit?.messageHandlers?.keanuCanvasA2UIAction ?? globalThis.keanuCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        if (handler === globalThis.keanuCanvasA2UIAction) {
  ...
  render() {
    ...
    return b`
      ...
      ${c$2(
        this.surfaces,
        ([surfaceId]) => surfaceId,
        ([surfaceId, surface]) => b`<a2ui-surface
          .surfaceId=${surfaceId}
          .surface=${surface}
          .processor=${this.#processor}
        ></a2ui-surface>`,
...
if (!customElements.get("keanu-a2ui-host")) {
  customElements.define("keanu-a2ui-host", KeanuA2UIHost);
}
