...
${formatHelpExamples([
  ['keanu message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'keanu message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'keanu message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.keanu.ai/cli/message")}`,
    )
    .action(() => {
