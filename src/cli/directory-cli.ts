    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["keanu directory self --channel slack", "Show the connected account identity."],
          [
            'keanu directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["keanu directory groups list --channel discord", "List available groups/channels."],
          [
            "keanu directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.keanu.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
