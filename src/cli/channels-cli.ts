    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["keanu channels list", "List configured channels and auth profiles."],
          ["keanu channels status --probe", "Run channel status checks and probes."],
          [
            "keanu channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["keanu channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.keanu.ai/cli/channels",
        )}\n`,
    );
