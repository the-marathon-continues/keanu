...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/keanu/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/keanu/extensions",
        global: "/Users/x/.keanu/extensions",
        workspace: "/Users/x/ws/.keanu/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.keanu/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/keanu/extensions",
        global: "/Users/x/.keanu/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.keanu/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/keanu/extensions",
        global: "/Users/x/.keanu/extensions",
