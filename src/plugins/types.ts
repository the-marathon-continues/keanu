...
export type KeanuPluginConfigSchema = {
...
export type KeanuPluginToolContext = {
  config?: KeanuConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type KeanuPluginToolFactory = (
  ctx: KeanuPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type KeanuPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
  /**
   * If true, this tool is not included in the base context.
   * Agents can discover it via tool_search and invoke it on demand.
   * Use for specialized tools that aren't needed in every conversation.
   */
  deferred?: boolean;
};

export type KeanuPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<KeanuConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type KeanuPluginGatewayMethod = {
  method: string;
 ...
 */
export type KeanuPluginCommandDefinition = {
...
export type KeanuPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type KeanuPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type KeanuPluginCliContext = {
  program: Command;
  config: KeanuConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type KeanuPluginCliRegistrar = (ctx: KeanuPluginCliContext) => void | Promise<void>;

export type KeanuPluginServiceContext = {
  config: KeanuConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type KeanuPluginService = {
  id: string;
  start: (ctx: KeanuPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: KeanuPluginServiceContext) => void | Promise<void>;
};

export type KeanuPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type KeanuPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: KeanuPluginConfigSchema;
  register?: (api: KeanuPluginApi) => void | Promise<void>;
  activate?: (api: KeanuPluginApi) => void | Promise<void>;
};

export type KeanuPluginModule =
  | KeanuPluginDefinition
  | ((api: KeanuPluginApi) => void | Promise<void>);

export type KeanuPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | KeanuPluginToolFactory,
    opts?: KeanuPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: KeanuPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: KeanuPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: KeanuPluginHttpRouteHandler }) => void;
  registerChannel: (registration: KeanuPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: KeanuPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: KeanuPluginService) => void;
   ...
   */
  registerCommand: (command: KeanuPluginCommandDefinition) => void;
