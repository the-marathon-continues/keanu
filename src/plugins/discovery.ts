...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @keanu/voice-call -> voice-call).
...
export function discoverKeanuPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".keanu", "extensions")];
