...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.KEANU_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: KeanuConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: KeanuConfig): string {
...
function mergeTelegramAccountConfig(cfg: KeanuConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: KeanuConfig): ResolvedTelegramAccount[] {
