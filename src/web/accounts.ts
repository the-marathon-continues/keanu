...
export function listWhatsAppAuthDirs(cfg: KeanuConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: KeanuConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: KeanuConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: KeanuConfig): ResolvedWhatsAppAccount[] {
