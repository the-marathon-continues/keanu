...
import { type KeanuConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: KeanuConfig): string[] {
...
export function listAgentsForGateway(cfg: KeanuConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: KeanuConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: KeanuConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: KeanuConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: KeanuConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: KeanuConfig): GatewaySessionsDefaults {
