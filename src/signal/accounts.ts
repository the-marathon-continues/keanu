...
function mergeSignalAccountConfig(cfg: KeanuConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: KeanuConfig): ResolvedSignalAccount[] {
