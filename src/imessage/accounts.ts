...
function mergeIMessageAccountConfig(cfg: KeanuConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: KeanuConfig): ResolvedIMessageAccount[] {
