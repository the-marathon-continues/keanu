...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.keanu.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("keanu hooks list")}`,
      `  ${formatCliCommand("keanu hooks enable <name>")}`,
      `  ${formatCliCommand("keanu hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
