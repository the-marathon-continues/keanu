...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@keanu", { botUsername: "keanu" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@keanu args", {
        botUsername: "keanu",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "keanu" })).toBe("/help@otherbot");
  });
