...
function resolveMentionPatterns(cfg: KeanuConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: KeanuConfig | undefined, agentId?: string): RegExp[] {
