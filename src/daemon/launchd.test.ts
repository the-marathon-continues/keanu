...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.keanu.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", KEANU_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.keanu.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when KEANU_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.keanu.gateway.plist",
    },
    {
      name: "uses profile-specific label when KEANU_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", KEANU_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.keanu.jbphoenix.plist",
    },
    {
      name: "prefers KEANU_LAUNCHD_LABEL over KEANU_PROFILE",
      env: {
        HOME: "/Users/test",
        KEANU_PROFILE: "jbphoenix",
        KEANU_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from KEANU_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        KEANU_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty KEANU_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        KEANU_PROFILE: "myprofile",
        KEANU_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.keanu.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
