...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): KeanuConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: KeanuConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: KeanuConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
