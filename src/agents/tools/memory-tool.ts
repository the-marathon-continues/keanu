...
function resolveMemoryToolContext(options: { config?: KeanuConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: KeanuConfig): MemoryCitationsMode {
