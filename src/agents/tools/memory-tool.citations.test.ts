...
function asKeanuConfig(config: Partial<KeanuConfig>): KeanuConfig {
  return config as KeanuConfig;
}

function createToolConfig() {
  return asKeanuConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: KeanuConfig = createToolConfig()) {
