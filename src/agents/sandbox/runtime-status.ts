...
function resolveMainSessionKeyForSandbox(params: { cfg?: KeanuConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: KeanuConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`keanu sandbox explain --session ${runtime.sessionKey}`)}`);
