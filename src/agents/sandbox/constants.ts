...
export const DEFAULT_SANDBOX_IMAGE = "keanu-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "keanu-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "keanu-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "keanu-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "keanu-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "keanu-sandbox-browser";
