...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  {
    id: "system_dns_queries",
    label: "system_dns_queries",
    description: "Query DNS lookups from system extensions",
    sectionId: "system",
    profiles: [],
    includeInKeanuGroup: true,
  },
  {
    id: "system_processes",
    label: "system_processes",
    description: "Query process executions from system extensions",
    sectionId: "system",
    profiles: [],
    includeInKeanuGroup: true,
  },
  {
    ...
    description: "Query file access events from system extensions",
    sectionId: "system",
    profiles: [],
    includeInKeanuGroup: true,
  },
  {
    id: "system_network_flows",
    label: "system_network_flows",
    description: "Query network flows from system extensions",
    sectionId: "system",
    profiles: [],
    includeInKeanuGroup: true,
  },
  {
    id: "system_extension_stats",
    label: "system_extension_stats",
    description: "Get system extension event statistics",
    sectionId: "system",
    profiles: [],
    includeInKeanuGroup: true,
  },
...
function buildCoreToolGroupMap() {
  ...
  const keanuTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInKeanuGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:keanu": keanuTools,
