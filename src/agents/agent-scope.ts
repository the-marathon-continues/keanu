...
type AgentEntry = NonNullable<NonNullable<KeanuConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: KeanuConfig): AgentEntry[] {
...
export function listAgentIds(cfg: KeanuConfig): string[] {
...
export function resolveDefaultAgentId(cfg: KeanuConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: KeanuConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentSkillsFilter(cfg: KeanuConfig, agentId: string): string[] | undefined {
...
export function resolveAgentModelPrimary(cfg: KeanuConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: KeanuConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: KeanuConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
