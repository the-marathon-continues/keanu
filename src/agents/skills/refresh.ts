...
function resolveWatchPaths(workspaceDir: string, config?: KeanuConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: KeanuConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: KeanuConfig }) {
