...
function resolveAvatarSource(cfg: KeanuConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: KeanuConfig, agentId: string): AgentAvatarResolution {
