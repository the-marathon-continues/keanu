...
function resolveAdaptiveReadMaxBytes(options?: KeanuReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createKeanuReadTool(base, {
...
export function createKeanuReadTool(
  base: AnyAgentTool,
  options?: KeanuReadToolOptions,
): AnyAgentTool {
