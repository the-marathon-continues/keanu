...
const CLEANUP_STATE_KEY = Symbol.for("keanu.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("keanu.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("keanu.sessionWriteLockWatchdogState");
