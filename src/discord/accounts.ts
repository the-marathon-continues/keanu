...
function mergeDiscordAccountConfig(cfg: KeanuConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: KeanuConfig): ResolvedDiscordAccount[] {
