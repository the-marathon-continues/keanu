...
describe("agent components", () => {
  const createCfg = (): KeanuConfig => ({}) as KeanuConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/keanu-sessions-test.json");
  });
