...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof KeanuConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: KeanuConfig; env: NodeJS.ProcessEnv }): {
  cfg: KeanuConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
