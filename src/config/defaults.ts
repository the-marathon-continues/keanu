...
function resolveAnthropicDefaultAuthMode(cfg: KeanuConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: KeanuConfig): KeanuConfig {
...
export function applyTalkApiKey(config: KeanuConfig): KeanuConfig {
...
export function applyTalkConfigNormalization(config: KeanuConfig): KeanuConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: KeanuConfig): KeanuConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: KeanuConfig): KeanuConfig {
...
export function applyLoggingDefaults(cfg: KeanuConfig): KeanuConfig {
...
export function applyContextPruningDefaults(cfg: KeanuConfig): KeanuConfig {
...
export function applyCompactionDefaults(cfg: KeanuConfig): KeanuConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
