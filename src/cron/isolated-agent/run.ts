...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/keanu/keanu/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.KEANU_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.keanu/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: KeanuConfig = {
    ...params.cfg,
