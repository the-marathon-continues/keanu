...
const execHostEnforced = process.env.KEANU_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.KEANU_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
