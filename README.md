...
An alignment layer for AI systems. Built on [Keanu](https://keanu.ai).
...
That's it. Installs deps, sets up config, typechecks. First run creates `~/.keanu/keanu.json` with sane defaults (no channels enabled — just the gateway and keanu).
...
src/                       keanu gateway (forked from keanu)
...
Keanu is built on [Keanu](https://github.com/keanu/keanu), an open-source AI gateway. For gateway docs, channels, models, and the full platform: [docs.keanu.ai](https://docs.keanu.ai).
...
Keanu connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.keanu.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.keanu.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.keanu.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.keanu.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.keanu.ai/nodes/voicewake) + [Talk Mode](https://docs.keanu.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.keanu.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.keanu.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.keanu.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.keanu.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.keanu.ai/nodes).
- **[Onboarding](https://docs.keanu.ai/start/wizard) + [skills](https://docs.keanu.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.
...
- [Gateway WS control plane](https://docs.keanu.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.keanu.ai/web), and [Canvas host](https://docs.keanu.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.keanu.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.keanu.ai/start/wizard), and [doctor](https://docs.keanu.ai/gateway/doctor).
- [Pi agent runtime](https://docs.keanu.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.keanu.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.keanu.ai/channels/groups).
- [Media pipeline](https://docs.keanu.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.keanu.ai/nodes/audio).

### Channels

- [Channels](https://docs.keanu.ai/channels): [WhatsApp](https://docs.keanu.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.keanu.ai/channels/telegram) (grammY), [Slack](https://docs.keanu.ai/channels/slack) (Bolt), [Discord](https://docs.keanu.ai/channels/discord) (discord.js), [Google Chat](https://docs.keanu.ai/channels/googlechat) (Chat API), [Signal](https://docs.keanu.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.keanu.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.keanu.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.keanu.ai/channels/msteams) (extension), [Matrix](https://docs.keanu.ai/channels/matrix) (extension), [Zalo](https://docs.keanu.ai/channels/zalo) (extension), [Zalo Personal](https://docs.keanu.ai/channels/zalouser) (extension), [WebChat](https://docs.keanu.ai/web/webchat).
- [Group routing](https://docs.keanu.ai/channels/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.keanu.ai/channels).

### Apps + nodes

- [macOS app](https://docs.keanu.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.keanu.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.keanu.ai/nodes/talk) overlay, [WebChat](https://docs.keanu.ai/web/webchat), debug tools, [remote gateway](https://docs.keanu.ai/gateway/remote) control.
- [iOS node](https://docs.keanu.ai/platforms/ios): [Canvas](https://docs.keanu.ai/platforms/mac/canvas), [Voice Wake](https://docs.keanu.ai/nodes/voicewake), [Talk Mode](https://docs.keanu.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.keanu.ai/platforms/android): [Canvas](https://docs.keanu.ai/platforms/mac/canvas), [Talk Mode](https://docs.keanu.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.keanu.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.keanu.ai/tools/browser): dedicated keanu Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.keanu.ai/platforms/mac/canvas): [A2UI](https://docs.keanu.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.keanu.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.keanu.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.keanu.ai/automation/cron-jobs); [webhooks](https://docs.keanu.ai/automation/webhook); [Gmail Pub/Sub](https://docs.keanu.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.keanu.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.keanu.ai/channels/channel-routing), [retry policy](https://docs.keanu.ai/concepts/retry), and [streaming/chunking](https://docs.keanu.ai/concepts/streaming).
- [Presence](https://docs.keanu.ai/concepts/presence), [typing indicators](https://docs.keanu.ai/concepts/typing-indicators), and [usage tracking](https://docs.keanu.ai/concepts/usage-tracking).
- [Models](https://docs.keanu.ai/concepts/models), [model failover](https://docs.keanu.ai/concepts/model-failover), and [session pruning](https://docs.keanu.ai/concepts/session-pruning).
- [Security](https://docs.keanu.ai/gateway/security) and [troubleshooting](https://docs.keanu.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.keanu.ai/web) + [WebChat](https://docs.keanu.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.keanu.ai/gateway/tailscale) or [SSH tunnels](https://docs.keanu.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.keanu.ai/install/nix) for declarative config; [Docker](https://docs.keanu.ai/install/docker)-based installs.
- [Doctor](https://docs.keanu.ai/gateway/doctor) migrations, [logging](https://docs.keanu.ai/logging).
...
- **[Gateway WebSocket network](https://docs.keanu.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.keanu.ai/gateway)).
- **[Tailscale exposure](https://docs.keanu.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.keanu.ai/gateway/remote)).
- **[Browser control](https://docs.keanu.ai/tools/browser)** — keanu‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.keanu.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.keanu.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.keanu.ai/nodes/voicewake) + [Talk Mode](https://docs.keanu.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.keanu.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Keanu can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Keanu enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.keanu.ai/gateway/tailscale) · [Web surfaces](https://docs.keanu.ai/web)
...
Details: [Remote access](https://docs.keanu.ai/gateway/remote) · [Nodes](https://docs.keanu.ai/nodes) · [Security](https://docs.keanu.ai/gateway/security)
...
Details: [Nodes](https://docs.keanu.ai/nodes) · [macOS app](https://docs.keanu.ai/platforms/macos) · [Gateway protocol](https://docs.keanu.ai/concepts/architecture)
...
Details: [Session tools](https://docs.keanu.ai/concepts/session-tool)
...
Runbook: [iOS connect](https://docs.keanu.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.keanu.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.keanu/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.keanu/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.keanu/keanu.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.keanu.ai/gateway/configuration)
...
Details: [Security guide](https://docs.keanu.ai/gateway/security) · [Docker + sandboxing](https://docs.keanu.ai/install/docker) · [Sandbox config](https://docs.keanu.ai/gateway/configuration)

### [WhatsApp](https://docs.keanu.ai/channels/whatsapp)

- Link the device: `pnpm keanu channels login` (stores creds in `~/.keanu/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.keanu.ai/channels/telegram)
...
### [Slack](https://docs.keanu.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.keanu.ai/channels/discord)
...
### [Signal](https://docs.keanu.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.keanu.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.keanu.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.keanu.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.keanu.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.keanu.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.keanu.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.keanu.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.keanu.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.keanu.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.keanu.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.keanu.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.keanu.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.keanu.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.keanu.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.keanu.ai/platforms/windows), [Linux](https://docs.keanu.ai/platforms/linux), [macOS](https://docs.keanu.ai/platforms/macos), [iOS](https://docs.keanu.ai/platforms/ios), [Android](https://docs.keanu.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.keanu.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.keanu.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.keanu.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.keanu.ai/gateway/bonjour)
- [Gateway pairing](https://docs.keanu.ai/gateway/pairing)
- [Remote gateway README](https://docs.keanu.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.keanu.ai/web/control-ui)
- [Dashboard](https://docs.keanu.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.keanu.ai/gateway/health)
- [Gateway lock](https://docs.keanu.ai/gateway/gateway-lock)
- [Background process](https://docs.keanu.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.keanu.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.keanu.ai/logging)

## Deep dives

- [Agent loop](https://docs.keanu.ai/concepts/agent-loop)
- [Presence](https://docs.keanu.ai/concepts/presence)
- [TypeBox schemas](https://docs.keanu.ai/concepts/typebox)
- [RPC adapters](https://docs.keanu.ai/reference/rpc)
- [Queue](https://docs.keanu.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.keanu.ai/tools/skills-config)
- [Default AGENTS](https://docs.keanu.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.keanu.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.keanu.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.keanu.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.keanu.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.keanu.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.keanu.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.keanu.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.keanu.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.keanu.ai/platforms/mac/voicewake)
- [iOS node](https://docs.keanu.ai/platforms/ios)
- [Android node](https://docs.keanu.ai/platforms/android)
- [Windows (WSL2)](https://docs.keanu.ai/platforms/windows)
- [Linux app](https://docs.keanu.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.keanu.ai/gmail-pubsub](https://docs.keanu.ai/automation/gmail-pubsub)

## Keanu

An alignment layer for AI systems. Built by **Drew Kemp-Dahlberg** on [Keanu](https://keanu.ai). 🐕
...
- Built on [Keanu](https://keanu.ai) by [Peter Steinberger](https://steipete.me) and [Mario Zechner](https://mariozechner.at/)
...
<p align="left">
  ...
  <a href="https://github.com/buerbaumer"><img src="https://avatars.githubusercontent.com/u/44548809?v=4&s=48" width="48" height="48" alt="Harald Buerbaumer" title="Harald Buerbaumer"/></a> <a href="https://github.com/akoscz"><img src="https://avatars.githubusercontent.com/u/1360047?v=4&s=48" width="48" height="48" alt="akoscz" title="akoscz"/></a> <a href="https://github.com/Bridgerz"><img src="https://avatars.githubusercontent.com/u/24499532?v=4&s=48" width="48" height="48" alt="Bridgerz" title="Bridgerz"/></a> <a href="https://github.com/hsrvc"><img src="https://avatars.githubusercontent.com/u/129702169?v=4&s=48" width="48" height="48" alt="hsrvc" title="hsrvc"/></a> <a href="https://github.com/magimetal"><img src="https://avatars.githubusercontent.com/u/36491250?v=4&s=48" width="48" height="48" alt="magimetal" title="magimetal"/></a> <a href="https://github.com/keanu-bot"><img src="https://avatars.githubusercontent.com/u/258178069?v=4&s=48" width="48" height="48" alt="keanu-bot" title="keanu-bot"/></a> <a href="https://github.com/meaningfool"><img src="https://avatars.githubusercontent.com/u/2862331?v=4&s=48" width="48" height="48" alt="meaningfool" title="meaningfool"/></a> <a href="https://github.com/JustasMonkev"><img src="https://avatars.githubusercontent.com/u/59362982?v=4&s=48" width="48" height="48" alt="JustasM" title="JustasM"/></a> <a href="https://github.com/Phineas1500"><img src="https://avatars.githubusercontent.com/u/41450967?v=4&s=48" width="48" height="48" alt="Phineas1500" title="Phineas1500"/></a> <a href="https://github.com/ENCHIGO"><img src="https://avatars.githubusercontent.com/u/38551565?v=4&s=48" width="48" height="48" alt="ENCHIGO" title="ENCHIGO"/></a>
