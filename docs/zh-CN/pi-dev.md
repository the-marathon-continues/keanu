...
本指南总结了在 Keanu 中开发 Pi 集成的合理工作流程。
...
状态存储在 Keanu 状态目录下。默认为 `~/.keanu`。如果设置了 `KEANU_STATE_DIR`，则使用该目录。
...
- https://docs.keanu.ai/testing
- https://docs.keanu.ai/start/getting-started
