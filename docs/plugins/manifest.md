...
read_when:
  - You are building a Keanu plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (keanu.plugin.json)

Every plugin **must** ship a `keanu.plugin.json` file in the **plugin root**.
Keanu uses this manifest to validate configuration **without executing plugin
