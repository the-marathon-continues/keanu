...
read_when:
  - You want to place an outbound voice call from Keanu
...
Voice calls for Keanu via a plugin. Supports outbound notifications and
...
- Use `keanu voicecall ...` or the `voice_call` tool
