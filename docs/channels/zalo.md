...
- Install via CLI: `keanu plugins install @keanu/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `keanu plugins install ./extensions/zalo`
   - From npm (if published): `keanu plugins install @keanu/zalo`
...
- Approve via:
  - `keanu pairing list zalo`
  - `keanu pairing approve zalo <CODE>`
...
- Example: `keanu message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `keanu channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `keanu logs --follow`
