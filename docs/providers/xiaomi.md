---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Keanu"
read_when:
  - You want Xiaomi MiMo models in Keanu
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Keanu uses
