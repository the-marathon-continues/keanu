...
import type { IntentSignals } from "../layer-6-narrative/seasons.ts";
import type { HumanReading, BullshitReading } from "../shared/types.ts";
import { totalBullshitScore } from "./struggle.ts";
