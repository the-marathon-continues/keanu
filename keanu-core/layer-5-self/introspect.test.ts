...
import type { DisagreementStats } from "../shared/types.js";
...
describe("introspect — rotation", () => {
  it("each call advances the rotation by 3 questions", async () => {
    ...
    const _set2 = new Set(r2.questionsChecked);
