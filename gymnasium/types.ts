...
import type { Challenge, ChallengeResult, ComparisonResult } from "../problem-sets/types.ts";

// Re-export for convenience
export type { Challenge, ChallengeResult, ComparisonResult } from "../problem-sets/types.ts";
